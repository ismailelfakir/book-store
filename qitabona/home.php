...
<section class="home">
   ...
   <div class="content">
      <h3>HELLO THERE</h3>
      <p>We are QITABONA community!! <br> We are here to help you exploring the world,
...
<section class="products">
   ...
   <div class="box-container">
     ...
     <form action="" method="post" class="box">
      ...
      <a href="home.php?show=<?php echo $fetch_products['id']; ?>" class="option-btn">show more</a></div>
     </form>
      <?php
         }
      }else{
...
<section class="about">
   ...
   <div class="flex">
      ...
      <div class="content">
         <h3>Benefit from reading?</h3>
         <p>Reading is so important it's the first AYA from ALLAH to the prophet MUHAMMADﷺ<br>
            which is "IQRA"Surah Al Alaq means read.</p>
